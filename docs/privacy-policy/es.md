# Política de Privacidad de Listize

_Última actualización: 7 de octubre de 2024_

En **Listize**, nos comprometemos a proteger su privacidad. Esta Política de Privacidad describe cómo recopilamos, utilizamos y protegemos su información cuando usa nuestra aplicación de lista de compras ("la Aplicación"). Al usar **Listize**, usted acepta esta Política de Privacidad. Si no está de acuerdo con estos términos, por favor no utilice la Aplicación.
...
- **Contenido de la lista de compras** (por ejemplo, artículos que agrega, categorías)
- **Metadatos relacionados** (por ejemplo, cantidades, preferencias, restricciones dietéticas o hábitos de compra)
...
- **Proporcionar y Mejorar la Aplicación**: Incluye solución de problemas, mejora de funciones y garantía de funcionalidad en diferentes dispositivos.
- **Servicios de IA**: Procesamiento de datos de listas de compras con servicios de IA externos para generar recomendaciones, mejorar sugerencias de listas y mejorar su experiencia de compra.
- **Gestión de Cuenta**: Permitirle iniciar sesión y gestionar su cuenta mediante inicio de sesión social y acceder a ciertas funciones de la Aplicación.
- **Atención al Cliente**: Abordar cualquier problema o inquietud que plantee a través de comentarios u otra comunicación.

No recopilamos ni utilizamos información personal para ningún otro propósito sin su consentimiento.
...
Nos tomamos en serio la seguridad de los datos e implementamos medidas estándar de la industria para proteger sus detalles de cuenta, datos de lista de compras e información del dispositivo. Cuando inicia sesión a través de redes sociales o comparte listas de compras para procesamiento de IA, utilizamos protocolos seguros para garantizar la protección de sus datos. Sin embargo, ningún sistema es completamente seguro, y no podemos garantizar la seguridad absoluta de su información.
...
La Aplicación está destinada a usuarios mayores de 13 años. No recopilamos conscientemente información personal de menores de 13 años. Si nos enteramos de datos recopilados de un menor de 13 años, eliminaremos rápidamente esa información.

## 7. Cambios en esta Política de Privacidad

Podemos actualizar esta Política de Privacidad ocasionalmente. Cualquier cambio se publicará dentro de la Aplicación, y la fecha de "Última actualización" se revisará en consecuencia. Su uso continuado de **Listize** después de las actualizaciones significa que acepta los cambios.
